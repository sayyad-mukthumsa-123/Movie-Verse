    ...
    <div className="App">
      ...
      <BrowserRouter>
        <Routes>
          ...
          {/* //r-r */}
          {/* Movie review and rating route */}
          {/* <Route path="/movie/:movieId/review-rating" render={(props) => {
          const movieId = props.match.params.movieId;
          return <ReviewRating movieId={movieId} />;
        }} /> */}
          <Route path="/movie/:movieId/review-rating" element={
            <ProtectedRoute><ReviewRating />
            </ProtectedRoute>} />

          {/* Movie details route */}
          {/* <Route path="/movie/:movieId" render={(props) => {
          const movieId = props.match.params.movieId;
          return <MovieDetails movieId={movieId} />; // Your movie details component
        }} /> */}

          <Route path="/contact" element={
            <ProtectedRoute><ContactUs />
            </ProtectedRoute>} />
        </Routes>
