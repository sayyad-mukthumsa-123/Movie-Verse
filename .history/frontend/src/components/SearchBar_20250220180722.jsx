    ...
    <form onSubmit={handleSearch} className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
      ...
      <div className="btn-search">
        <Button
          ...
          type="submit"
          // id="btn-search"
          className="w-full md:w-auto px-6 py-3 text-xl border border-blue-500 text-cyan-700 rounded-md hover:bg-blue-500 hover:text-white transition-all hover:scale-105"
        >
          Search
        </Button>
      </div>
