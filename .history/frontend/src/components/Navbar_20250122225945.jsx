  ...
  return (
    <nav className="bg-cyan-800 p-4 shadow-md">
      <div className="container mx-auto flex items-center justify-between flex-wrap">
        <div className="flex space-x-6 sm:space-x-10 w-full sm:w-auto justify-between sm:justify-start">
          <Link 
            to="/popular" 
            onClick={onPopularClick} 
            className="text-white text-2xl sm:text-10xl font-semibold hover:text-cyan-300 hover:underline hover:scale-110 transition-transform duration-300"
          >
            Popular Movies
          </Link>
          <Link 
            to="/trending" 
            onClick={onTrendingClick} 
            className="text-white text-2xl sm:text-xl font-semibold hover:text-cyan-300 hover:underline hover:scale-110 transition-transform duration-300"
          >
            Trending Movies
          </Link>
          <Link 
        ...
        <div>
          <button
            onClick={handleLogout}
            className="text-white text-xl sm:text-2xl font-semibold bg-red-600 hover:bg-red-500 hover:scale-110 py-2 px-4 rounded-md transition-transform duration-300"
          >
            Logout
          </button>
        </div>
