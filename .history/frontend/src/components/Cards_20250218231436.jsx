...
const Cards = ({ movie }) => {
  ...
  return (
    <div
      className="bg-slate-50 p-4 rounded-lg shadow-lg outline-none cursor-pointer  hover:scale-105 hovertransicyan-700transform duration-300"
    ...
    >
      ...
      <button
        ...
        className="mt-3  text-cyan-700 py-2 px-4 rounded-lg hover:bg-cyan-700"
      >
        Review & Rating
      </button>
    </div>
