  ...
  return (
    <nav className="bg-cyan-800 p-4 shadow-md">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center justify-between w-full sm:w-auto">
          {/* Logo */}
          <Link to="/" className="text-white text-3xl font-semibold sm:text-4xl">
            MovieDB
          </Link>
        ...
        {/* Navbar Links */}
        <div className={`sm:flex ${isMenuOpen ? 'block' : 'hidden'} sm:block flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-10`}>
          <Link 
            to="/popular" 
            onClick={onPopularClick} 
