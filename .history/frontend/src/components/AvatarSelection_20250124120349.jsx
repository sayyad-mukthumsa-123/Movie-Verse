        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
            {avatars.map((avatarUrl, index) => (
              <div
                key={index}
                className={`relative cursor-pointer rounded-lg overflow-hidden ${selectedAvatar === avatarUrl ? "border-4 border-teal-400" : "border-2 border-gray-300"
                  }`}
              ...
              >
                ...
                {selectedAvatar === avatarUrl && (
                  <div className="absolute inset-0 bg-slate-500 bg-opacity-20 flex justify-center items-center text-red-800 font-bold outline-cyan-800">
                    Selected
                  </div>
                )}
              </div>
