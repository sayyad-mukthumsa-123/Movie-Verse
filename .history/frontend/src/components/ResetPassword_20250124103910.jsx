        ...
        <form className="space-y-6" onSubmit={handleResetPassword}>
          <div>
            ...
            <input
              ...
              required
              readOnly
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm   focus:outline-cyan-800 sm:text-sm"
            />
          </div>
          <div>
            ...
            <div className="relative">
              ...
              <button
                type="button"
                className="absolute text-xl right-3 top-1 font-bold text-cyan-800"
          ...
          <button
            type="submit"
            className="w-full scale-90 text-2xl bg-green-800 text-white font-semibold py-2 px-4 rounded-md hover:bg-green-700  hover:scale-100 transition-transform focus:outline-none focus:ring-2 focus:ring-offset-2 "
          >
            Reset Password
          </button>
        </form>
