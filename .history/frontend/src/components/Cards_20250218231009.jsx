...
const Cards = ({ movie }) => {
  ...
  return (
    <div
      className="bg-slate-50 p-4 rounded-lg shadow-lg outline-none cursor-pointer hover:outline-cyan-800 hover:scale-105 hover:shadow-xl transition-transform duration-300"
