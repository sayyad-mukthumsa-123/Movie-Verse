        ...
        <div className={`sm:flex ${isMenuOpen ? 'flex-col space-y-4' : 'hidden'} sm:block sm:flex-row sm:space-y-0 sm:space-x-10`}>
          ...
          {userEmail && (
            <Link 
              ...
              className="text-2xl sm:text-3xl font-semibold text-slate-50 hover:bg-gradient-to-r hover:from-cyan-200 hover:via-white hover:to-cyan-500 hover:bg-clip-text hover:text-transparent hover:scale-110 transition-transform duration-300"
            >
              Profile
            </Link>
          )}
