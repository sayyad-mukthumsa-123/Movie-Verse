    ...
    <nav className="bg-cyan-800 p-4 shadow-md">
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex space-x-6">
          <Link to="/popular" onClick={onPopularClick} className="text-white font-semibold text-2xl hover:text-cyan-300">
            Popular Movies
          </Link>
          <Link to="/trending" onClick={onTrendingClick} className="text-white font-semibold hover:text-cyan-300">
            Trending Movies
          </Link>
          <Link to="/search" className="text-white font-semibold hover:text-cyan-300">
            Search
          </Link>
          {/* Profile Link */}
          {userEmail && (
            <Link to={`../api/profile/${userEmail}`} className="text-white font-semibold hover:text-cyan-300">
              Profile
            </Link>
          )}
        </div>
