      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className={`sm:flex ${isMenuOpen ? 'flex-col space-y-4' : 'hidden'} sm:block sm:flex-row sm:space-y-0 sm:space-x-10`}>
          <Link 
            ...
            className=" text-2xl sm:text-3xl font-semibold hover:text-cyan-200  hover:scale-110 transition-transform duration-300"
          >
            Popular
          </Link>
          <Link 
            ...
            className=" text-2xl sm:text-3xl font-semibold hover:text-cyan-300 hover:underline hover:scale-110 transition-transform duration-300"
          >
            Trending
          </Link>
          <Link 
