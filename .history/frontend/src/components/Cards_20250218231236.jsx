...
const Cards = ({ movie }) => {
  ...
  return (
    <div
      className="bg-slate-50 p-4 rounded-lg shadow-lg outline-none cursor-pointer  hover:scale-105 hover:shadow-xl shadow-white transition-transform duration-300"
