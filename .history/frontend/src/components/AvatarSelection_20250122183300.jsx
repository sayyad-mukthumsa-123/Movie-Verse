    ...
    <div className="p-4">
      {isLoading ? (
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4 justify-center items-center">
            {avatars.map((avatarUrl, index) => (
              <div
                key={index}
              ...
              >
                <img
                  src={avatarUrl}
                  alt={`avatar-${index}`}
                  className="w-28 h-30 object-cover transition-transform transform hover:scale-105"
                />
