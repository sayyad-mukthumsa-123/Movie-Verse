      ...
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex space-x-6">
          ...
          <Link 
            ...
            className="text-white text-2xl font-semibold hover:text-cyan-300 hover:underline hover:scale-105 transition-all duration-300 hover:bg-white hover:shadow-lg "
          >
            Trending Movies
          </Link>
          <Link 
