    ...
    <form onSubmit={handleSearch} className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
      ...
      <div className="btn-search">
        <Button
          ...
          type="submit"
          // id="btn-search"
          className="w-full md:w-auto px-6 py-3 text-2xl border border-blue-500 text-white rounded-md hover:bg-blue-500 hover:text-white transition-colors hover:scale-110"
        >
          Search
        </Button>
      </div>
