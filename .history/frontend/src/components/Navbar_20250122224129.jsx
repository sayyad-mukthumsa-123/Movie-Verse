    ...
    <nav className="bg-cyan-800 p-4 shadow-md">
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex space-x-6">
          <Link to="/popular" onClick={onPopularClick} className="text-white font-semibold text-2xl hover:scale-110 transition-transform hover:bg-white hover:text-red-800">
            Popular Movies
          </Link>
