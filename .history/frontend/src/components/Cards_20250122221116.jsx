...
const Cards = ({ movie, onClick }) => {
  return (
    <div
      className="bg-gray-100  w-auto h-auto p-4 rounded-lg shadow-lg outline-none cursor-pointer  hover:outline-cyan-800 hover:scale-105 hover:shadow-xl transition-transform duration-300"
