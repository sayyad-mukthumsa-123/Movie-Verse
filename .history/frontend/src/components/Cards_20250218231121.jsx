...
const Cards = ({ movie }) => {
  ...
  return (
    <div
      className="bg-slate-50 p-4 rounded-lg shadow-lg outline-red cursor-pointer hover:outline-white hover:scale-105 hover:shadow-xl transition-transform duration-300"
