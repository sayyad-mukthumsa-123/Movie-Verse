  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
        ...
        {loading ? (
          <p className="text-center text-cyan-800 font-semibold">Loading...</p>
        ) : (
          <form className="space-y-6" onSubmit={handleResetPassword}>
            <div>
              <label className="block text-2xl font-medium text-cyan-800">Email (Read-Only)</label>
              <input
                ...
                value={email}
                readOnly
                className="mt-1 w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-cyan-800 text-2xl bg-gray-100"
              />
            </div>
            <div>
              <label className="block text-2xl font-medium text-cyan-800">New Password</label>
            ...
            <button
              type="submit"
              className={`w-full scale-90 text-2xl bg-green-800 text-white font-semibold py-2 px-4 rounded-md 
              hover:bg-green-700 hover:scale-100 transition-transform focus:outline-none ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
              disabled={loading}
            >
              Reset Password
            </button>
