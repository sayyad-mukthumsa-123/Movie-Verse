...
//       <h1 className="text-5xl font-bold text-cyan-800 mb-6">Profile</h1>
...
//             className="scale-90 bg-green-800 text-2xl text-white py-2 px-4 rounded-lg hover:bg-green-800  hover:scale-100  duration-300 transition"
//           >
//             Update Profile
//           </button>
//           <button
//             onClick={handleResetPasswordClick}
//             className="scale-90 bg-blue-500 text-2xl text-white py-2 px-4 rounded-lg hover:bg-blue-500 hover:scale-100  duration-300 transition"
//           >
//             Reset Password
//           </button>
//         </div>
    ...
    <div className="profile-page flex flex-col items-center justify-center min-h-screen bg-slate-200 px-4">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 w-full sm:w-96">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <button
            onClick={handleResetPasswordClick}
            className="w-full bg-blue-500 text-lg sm:text-2xl text-white py-2 px-4 rounded-lg hover:bg-blue-600 hover:scale-105 transition-transform duration-300"
          >
            Reset Password
          </button>
        </div>
