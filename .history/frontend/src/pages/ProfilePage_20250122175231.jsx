...
const ProfilePage = () => {
  ...
  return (
    <div className="profile-page flex flex-col items-center justify-center min-h-screen bg-slate-800">
      <h1 className="text-5xl font-bold text-orange-500 mb-6">User Profile</h1>
      <div className="bg-white shadow-md rounded-lg p-6 w-96">
        <div className="flex flex-col items-center mb-6">
          <img
            ...
            alt="Avatar"
            className="w-8 h-8 rounded-full border border-gray-300 mb-4"
            onError={handleImageError} // Handle image loading errors
          />
