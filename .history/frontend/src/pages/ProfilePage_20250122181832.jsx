      ...
      <div className="bg-white shadow-md rounded-lg p-6 w-96">
        ...
        <div className="flex flex-col space-y-4">
          <button
            ...
            className="scale-90 bg-green-800 text-xl text-white py-2 px-4 rounded-lg hover:bg-green-800  hover:scale-100  duration-300 transition"
          >
            Update Profile
          </button>
          <button
            onClick={handleResetPasswordClick}
            className="scale-90 bg-blue-500 text-xl text-white py-2 px-4 rounded-lg hover:bg-blue-500 hover:scale-105  duration-300 transition"
          >
            Reset Password
          </button>
        </div>
