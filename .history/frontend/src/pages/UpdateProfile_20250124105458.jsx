        ...
        <form className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-4">
            ...
            <button
              type="button"
              onClick={() => navigate(`/profile/${email}`)}
              className="w-full sm:w-5/12 bg-red-800 text-2xl  hover:bg-red-700 hover:scale-105 transition-transform text-white font-semibold py-2 px-4 rounded-md focus:outline-none"
            >
              Cancel
            </button>
          </div>
