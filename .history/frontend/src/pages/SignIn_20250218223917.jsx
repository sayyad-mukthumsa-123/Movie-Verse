      ...
      <div className="w-full max-w-md bg-white  outline text-black rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            className="w-full scale-95 bg-white text-3xl text-cyan-500 py-2 px-4 rounded-lg hover:bg-cyan-700 hover:scale-100 transition-transform outline-none focus:outline-none"
