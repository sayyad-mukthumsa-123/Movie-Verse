        ...
        <form className="space-y-6">
          ...
          <div className="flex justify-between">
            ...
            <button
              type="button"
              onClick={() => navigate(`/profile/${email}`)}
              className="w-5/12 text-2xl bg-red-500 hover:bg-red-500 hover:scale-110 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500"
            >
              Cancel
            </button>
          </div>
