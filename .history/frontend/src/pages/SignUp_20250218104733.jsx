  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-lg bg-white rounded-lg shadow-md p-6">
        ...
        {step === 2 && (
          <form onSubmit={handleSubmit}>
            <input type="email" value={email} readOnly className="w-full text-2xl px-4 py-2 border rounded-lg bg-gray-200" />
            <input type="text" placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)} className="w-full text-2xl px-4 py-2 border rounded-lg mt-4" />
            <input type="password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} className="w-full text-2xl px-4 py-2 border rounded-lg mt-4" />
            <input type="password" placeholder="Confirm Password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className="w-full text-2xl px-4 py-2 border rounded-lg mt-4" />
            <AvatarSelection onSelectAvatar={setSelectedAvatar} />
            <button type="submit" className="px-8 py-2 bg-cyan-800 text-white text-xl font-semibold rounded-lg mt-4">Sign Up</button>
          </form>
        )}
        <ToastContainer />
      </div>
