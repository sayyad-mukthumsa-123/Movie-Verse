...
const MovieDetail = () => {
  ...
  return (
    <div className="container  bg-slate-900 text-slate-50 mx-auto px-4 py-6">
      <div className="absolute top-2 left-6 cursor-pointer p-2 bg-slate-800 text-white rounded-full hover:bg-slate-700 transition">
      ...
      {movie && (
        <div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start md:space-x-6 mb-8">
            <div className="w-full md:w-1/3 m-6 md:mb-0">
              <img
