    ...
    <div className="container mx-auto px-4 py-6">
      {movie && (
        <div>
          ...
          {/* Trailer Section */}
          <div className="mb-8">
            <h2 className="text-3xl text-center font-semibold text-cyan-800 mt-20 mb-4 outline-cyan-800">Trailer</h2>
            {trailerUrl ? (
          ...
          {cast.length > 0 && (
            <div>
              <h2 className="text-3xl font-semibold text-center mt-20 text-cyan-800 mb-4">Cast</h2>
