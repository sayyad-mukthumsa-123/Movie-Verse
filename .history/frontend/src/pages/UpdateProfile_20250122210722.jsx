        ...
        <form className="space-y-6">
          <div>
            ...
            <input
              ...
              onChange={(e) => setUsername(e.target.value)}
              required
              className={` h-10 mt-1 block w-full px-3 py-2 text-lg border outline outline-cyan-800 rounded-md shadow-sm focus:ring-2 focus:ring-cyan-500 focus:outline-red-500 sm:text-sm`}
            />
          </div>
          <div>
            <AvatarSelection setSelectedAvatar={setSelectedAvatar} />
