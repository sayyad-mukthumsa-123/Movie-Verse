        ...
        <div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start md:space-x-6 mb-8">
            ...
            <div className="w-full md:w-2/3">
              ...
              <p className="text-2xl text-gray-800 mb-2">Released : {movie.release_date}</p>
              <p className="text-2xl text-gray-800 mb-2">Genre : {movie.genres.map(genre => genre.name).join(', ')}</p>
              <p className="text-2xl text-gray-800 mb-10">Director : {director}</p>
              ...
              <div className="mb-4">
                ...
                <p className="text-2xl font-bold text-gray-800 text-justify">{movie.overview}</p>
              </div>
            </div>
          </div>
