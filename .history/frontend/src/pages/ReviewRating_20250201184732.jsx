...
const ReviewRating = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto space-y-4">
        ...
        <button
          type="submit"
          className="w-full scale-95 text-xl py-3 bg-cyan-800 text-white font-bold rounded-lg hover:scale-100 transition-all hover:bg-cyan-700 "
        >
          Submit
        </button>
      </form>
      ...
      {/* <div className="mt-8">
        ...
        {reviews.length === 0 ? (
          ...
          reviews.map((review) => (
            <div key={review._id} className="mb-6 p-4 outline outline-slate-400 bg-gray-50 rounded-lg shadow-md flex justify-between items-center hover:shadow-2xl  hover:shadow-black transition-all">
              <div>
                <p className="text-lg font-semibold text-cyan-800">
                  <strong>{review.username}</strong> ({review.rating} ⭐)
                </p>
              ...
              {review.username === username && (
                <button
                  onClick={() => setConfirmDelete({ reviewId: review._id, reviewUsername: review.username })}
                  className="ml-4 py-2 px-4 bg-red-600 text-xl text-white font-bold rounded-lg hover:bg-red-700 transition-all hover:scale-105"
                >
                  Delete
                </button>
              )}
      ...
      <div className="mt-8">
        ...
        {reviews.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-10">
            {reviews.map((review) => (
              // <div key={review._id} className="p-4 outline outline-slate-400 bg-gray-50 rounded-lg shadow-md hover:shadow-2xl hover:shadow-black transition-all flex flex-col">
              ...
              //       <p className="text-gray-700 font-bold text-xl mt-2">{review.rating} ⭐</p>
              //       <p className="text-gray-700 text-xl mt-2">{review.reviewText}</p>
              //     </div>

              //     {review.username === username && (
              //       <button
              //         onClick={() => setConfirmDelete({ reviewId: review._id, reviewUsername: review.username })}
              //         className="ml-4 py-2 px-4 mt-auto mb-auto bg-red-600 text-xl text-white font-bold rounded-lg hover:bg-red-700 transition-all hover:scale-105"
              //       >
              //         Delete
              //       </button>
              //     )}
              ...
              //     {review.username === username && (
              //       <div className="flex items-end"> {/* Center vertically */}
              //         <button
              //           onClick={() => setConfirmDelete({ reviewId: review._id, reviewUsername: review.username })}
              //           className="py-2 px-4 mt-20 bg-red-600 text-xl text-white font-bold rounded-lg hover:bg-red-700 transition-all hover:scale-105"
              //         >
              //           Delete
              //         </button>
              //       </div>
  ...
  <div className="flex flex-col w-full mb-2">
    ...
    <div className="flex justify-between items-center mt-2">
      <div className="flex flex-col w-full">
        <p className="text-gray-700 font-bold text-xl">{review.rating} ⭐</p>
        <p className="text-gray-700 text-xl mt-2">{review.reviewText}</p>
      </div>
      ...
      {review.username === username && (
        <div className="flex items-center justify-center ml-4">
          <button
            onClick={() => setConfirmDelete({ reviewId: review._id, reviewUsername: review.username })}
            className="py-2 px-4 mt-auto mb-auto bg-red-600 text-xl text-white font-bold rounded-lg hover:bg-red-700 transition-all hover:scale-105"
          >
            Delete
          </button>
        </div>
