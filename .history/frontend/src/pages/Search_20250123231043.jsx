  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 w-full max-w-4xl">
        <Link
          to="/search/movie"
          className="bg-blue-500 scale-90 text-white text-3xl py-3 px-6 rounded-lg text-center hover:bg-blue-600 hover:scale-105 transition-all"
        ...
        <Link
          to="/search/director"
          className="bg-green-500 scale-90 text-white text-3xl py-3 px-6 rounded-lg text-center hover:bg-green-600 hover:scale-105 transition-all"
          onClick={clearSearchData}
        >
          Search by Director
        </Link>
        <Link
          to="/search/hero"
          className="bg-red-500 scale-90 text-white text-3xl py-3 px-6 rounded-lg text-center hover:bg-red-600 hover:scale-105 transition-all"
          onClick={clearSearchData}
        >
          Search by Hero
        </Link>
        <Link
          to="/search/heroine"
          className="bg-purple-500 scale-90 text-white text-3xl py-3 px-6 rounded-lg text-center hover:bg-purple-600 hover:scale-105 transition-all"
          onClick={clearSearchData}
        >
          Search by Heroine
        </Link>
        <Link
          to="/search/genre"
          className="bg-yellow-500 scale-90 text-white text-3xl py-3 px-6 rounded-lg text-center hover:bg-yellow-600 hover:scale-105 transition-all"
          onClick={clearSearchData}
        >
          Search by Genre
        </Link>
        <Link
          to="/search/lang"
          className="bg-indigo-500 scale-90 text-white text-4xl py-3 px-6 rounded-lg text-center hover:bg-indigo-600 hover:scale-105 transition-all"
          onClick={clearSearchData}
        >
          Search by Language
        </Link>
