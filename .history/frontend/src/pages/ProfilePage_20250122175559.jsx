...
const ProfilePage = () => {
  ...
  return (
    <div className="profile-page flex flex-col items-center justify-center min-h-screen bg-green-700">
      <h1 className="text-5xl font-bold text-gray-500 mb-6">User Profile</h1>
