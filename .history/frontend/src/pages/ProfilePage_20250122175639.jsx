...
const ProfilePage = () => {
  ...
  return (
    <div className="profile-page flex flex-col items-center justify-center min-h-screen bg-black-700">
      <h1 className="text-5xl font-bold text-yellow-500 mb-6">User Profile</h1>
