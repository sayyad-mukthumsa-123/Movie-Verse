    ...
    const fetchUserProfile = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setEmail(data.email);
          setPassword(data.password); // Password may not be needed to display
          setAvatar(data.avatar); // Set avatar URL
        } else {
            ...
            <div className="card-body p-4 p-sm-5">
              ...
              {avatar && (
                <div className="text-center mb-3">
                  <img src={avatar} alt="User Avatar" className="img-fluid rounded-circle" style={{ width: "100px", height: "100px" }} />
                </div>
              )}
