      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between">
            <button
              type="submit"
              className="w-5/12 bg-teal-600 hover:bg-teal-700 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500"
            >
              Save
            </button>
            <button
              ...
              className="w-6/12 mt-2 sm:mt-0 bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500"
            >
              Cancel
            </button>
          </div>
