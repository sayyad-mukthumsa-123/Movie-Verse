    ...
    <div className="flex items-center justify-center min-h-screen bg-black">
      <div className="w-full max-w-md bg-white  outline text-black rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full scale-95 bg-white text-3xl text-cyan-500 outline py-2 px-4 rounded-lg hover:bg-red-700 focus:outline-none hover:scale-100 transition-transform"
          >
            Sign In
          </button>
        </form>
