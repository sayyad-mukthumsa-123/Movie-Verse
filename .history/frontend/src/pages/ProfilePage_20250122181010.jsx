...
const ProfilePage = () => {
  ...
  return (
    <div className="profile-page flex flex-col items-center justify-center min-h-screen bg-slate-200">
      <h1 className="text-5xl font-bold text-orange-800 mb-6">Profile</h1>
      <div className="bg-white shadow-md rounded-lg p-6 w-96">
        ...
        <div className="flex flex-col space-y-4">
          <button
            ...
            className="bg-green-800 text-xl text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition"
          >
            Update Profile
          </button>
          <button
