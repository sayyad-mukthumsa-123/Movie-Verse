    ...
    return (
        <div className='flex flex-col justify-center items-center min-h-screen bg-gray-50'>
            <div className='text-center mb-10'>
                <h1 className='text-4xl font-bold text-indigo-600 mb-4'>MovieVerse</h1>
                <p className='text-lg text-gray-600 px-4 sm:px-8'>
                    Welcome to MovieVerse! Sign in or sign up to explore our movie universe.
                    Discover your next favorite film in an expansive universe of movie content. MovieVerse brings you the latest releases and timeless classics all in one place.
                </p>
            </div>
            <div className='flex space-x-4'>
                <Link to="/login" className=''>
                    <Button variant="outline-info" className="px-6 py-3 text-lg bg-transparent border-2 border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-600 hover:text-white transition-all duration-300">
                        Sign In
                    </Button>
                </Link>
