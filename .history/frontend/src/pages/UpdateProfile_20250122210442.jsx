        ...
        <form className="space-y-6">
          <div>
            ...
            <input
              ...
              onChange={(e) => setUsername(e.target.value)}
              required
              className={`mt-1 block w-full px-3 py-2 border outline outline-cyan-800 rounded-md shadow-sm focus:ring-2 focus:ring-cyan-500 focus:outline-red-500 sm:text-sm text-5xl`}
            />
          </div>
          <div>
            <AvatarSelection setSelectedAvatar={setSelectedAvatar} />
