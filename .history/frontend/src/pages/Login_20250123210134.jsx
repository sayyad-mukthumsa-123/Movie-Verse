      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4 relative">
            ...
            <button
              type="button"
              className="absolute text-xl top-1/2 right-3 transform -translate-y-1/2 text-sm text-cyan-800 hover:underline focus:outline-none"
              onClick={togglePasswordVisibility}
            >
              {passwordVisible ? "Hide" : "Show"}
            </button>
          ...
          <div className="text-sm text-right mb-4">
            <Link to="/reset_password" className="text-blue-500 hover:underline">
              Forgot Password?
            </Link>
          </div>
