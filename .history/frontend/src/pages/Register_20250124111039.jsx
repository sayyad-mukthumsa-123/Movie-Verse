      ...
      <div className="w-full max-w-lg bg-white rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4 relative">
            ...
            <button
              type="button"
              className="absolute top-14 right-3 text-xl font-semibold text-cyan-800 focus:outline-none"
              onClick={togglePasswordVisibility}
            >
              {passwordVisible ? "Hide" : "Show"}
            </button>
          ...
          <div className="mb-4 relative">
            ...
            <button
              type="button"
              className="absolute top-13 right-3 text-xl font-semibold text-cyan-800 focus:outline-none"
              onClick={toggleConfirmPasswordVisibility}
            >
              {confirmPasswordVisible ? "Hide" : "Show"}
            </button>
          ...
          <div className="text-xl mb-4 text-cyan-800">
            Already have an account?{" "}
            <Link to="/login" className="inline-block mx-2 text-blue-500 hover:underline hover:scale-105 transition-transform">
              SignIn
            </Link>
          </div>
          <button
