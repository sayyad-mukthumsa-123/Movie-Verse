...
function Home() {
  ...
  return (
    <>
      ...
      <div className="bg-slate-900 movies-container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8 hover:shadow-lg hover:shadow-red-500 p-4">
