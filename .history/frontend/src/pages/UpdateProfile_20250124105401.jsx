        ...
        <form className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-4">
            <button
              type="button"
              onClick={handleSave}
              className="w-full sm:w-5/12 bg-green-800 text-2xl sm:text-xl hover:bg-green-700 hover:scale-105 transition-transform text-white font-semibold py-2 px-4 rounded-md focus:outline-none"
            >
              Save
            </button>
            <button
