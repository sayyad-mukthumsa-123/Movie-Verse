    ...
    <div className="container mx-auto px-4 py-6">
      {movie && (
        <div>
          ...
          {/* Trailer Section */}
          <div className="mb-8">
            <h2 className="text-4xl text-center font-bold  bg-cyan-800 text-white p-4 mt-20 mb-2">Trailer</h2>
            {trailerUrl ? (
          ...
          {cast.length > 0 && (
            <div>
              <h2 className="text-4xl font-bold text-center mt-20 text-white bg-cyan-800 p-4 mb-2">Cast</h2>
