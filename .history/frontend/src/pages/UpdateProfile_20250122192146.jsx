        ...
        <form className="space-y-6">
          ...
          <div className="flex justify-between">
            <button
              ...
              className="w-5/12 bg-green-800 text-xl hover:bg-green-800 hover:scale-110 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:bg-green-800"
            >
              Save
            </button>
            <button
