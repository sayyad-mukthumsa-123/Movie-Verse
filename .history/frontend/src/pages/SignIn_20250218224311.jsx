...
const SignIn = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-900">
      <div className="w-full max-w-md bg-white  outline-red-500 text-black rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              type="email"
              id="email"
              className="w-full px-4 py-2 text-black border rounded-lg focus:outline-none focus:ring focus:ring-black text-2xl"
          ...
          <div className="mb-4 relative">
            ...
            <input
              ...
              id="password"
              className="mt-1 w-full px-4 py-2 text-black border rounded-lg focus:outline-none focus:ring focus:ring-black text-2xl"
          ...
          <button
            type="submit"
            //className="w-full scale-95 bg-white text-3xl text-cyan-500 outline py-2 px-4 rounded-lg hover:bg-cyan-700  hover:outline focus:outline-none hover:scale-100 transition-transform"
            className="w-full scale-95  text-3xl text-cyan-500 py-2 px-4 rounded-lg hover:bg-cyan-700 hover:text-white hover:scale-100 transition-transform outline focus:outline-none"
