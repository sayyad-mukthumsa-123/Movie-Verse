        ...
        <form className="space-y-6">
          <div>
            ...
            <input
              ...
              onChange={(e) => setUsername(e.target.value)}
              required
              className="mt-1 block w-full px-3 py-2 border outline-cyan-800 border-red-800 rounded-md shadow-sm focus:outline-none focus:ring-cyan-800 focus:border-cyan-800 sm:text-sm"
            />
          </div>
          <div>
            <AvatarSelection setSelectedAvatar={setSelectedAvatar} />
