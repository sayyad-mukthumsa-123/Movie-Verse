        ...
        <div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start md:space-x-6 mb-8">
            ...
            <div className="w-full md:w-2/3">
              <h1 className="text-3xl md:text-4xl font-bold text-cyan-800 mt-6 mb-10">{movie.title}</h1>
              <p className="text-2xl text-gray-700 mb-2">Released : {movie.release_date}</p>
              <p className="text-2xl text-gray-700 mb-2">Genre : {movie.genres.map(genre => genre.name).join(', ')}</p>
              <p className="text-2xl text-gray-700 mb-10">Director : {director}</p>
              {/* <p className="text-lg text-gray-800">Overview:  {movie.overview}</p> */}
              <div className="mb-4">
                <p className="text-3xl font-semibold text-gray-800 mb-2">Overview :</p>
                <p className="text-2xl text-gray-800">{movie.overview}</p>
              </div>
            </div>
          </div>
          ...
          {/* Trailer Section */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-cyan-800 mb-4">Trailer</h2>
            {trailerUrl ? (
          ...
          {cast.length > 0 && (
            <div>
              <h2 className="text-2xl font-semibold text-cyan-800 mb-4">Cast</h2>
