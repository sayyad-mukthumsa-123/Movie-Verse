    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mt-8">
        ...
        {reviews.length === 0 ? (
          ...
          reviews.map((review) => (
            <div key={review._id} className="mb-6 p-4 outline outline-slate-400 bg-gray-50 rounded-lg shadow-md flex justify-between items-center hover:shadow-sm hover:shadow-black transition-all">
              <div>
                <p className="text-lg font-semibold text-cyan-800">
                  <strong>{review.username}</strong> ({review.rating} ⭐)
                </p>
