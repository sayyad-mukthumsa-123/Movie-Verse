...
const MovieRecommendations = ({ movieId }) => {
  ...
  // Scroll to top of the page whenever recommendations are updated
  useEffect(() => {
    window.scrollTo(0, 0);
  }, [recommendations]); // This runs when recommendations state changes
  ...
  // Handle movie click and navigate to MovieDetail page
  const handleMovieClick = (movieId) => {
    // Use navigate with replace to ensure history is updated
