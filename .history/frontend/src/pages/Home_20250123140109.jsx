...
const Home = () => {
    return (
        <div className='flex flex-col items-center justify-center h-screen bg-gray-900 text-white p-4'>
            <div className='text-center mb-8'>
                <h1 className='text-4xl font-bold mb-4'>MovieVerse</h1>
            ...
            <div className='flex gap-4'>
                <Link to="/login" className='w-full sm:w-auto'>
                    <Button variant="outline-info" id='btn1' className='w-full py-2 px-6 text-lg border-2 border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white transition duration-300'>
                        Sign In
                    </Button>
                </Link>
