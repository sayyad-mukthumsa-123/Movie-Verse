...
const Home = () => {
    return (
        <div className='bg-gray-100 min-h-screen flex flex-col justify-center items-center py-10'>
            <div className='text-center mb-8'>
                <h1 className='text-5xl font-bold text-blue-600'>MovieVerse</h1>
            ...
            <div className='flex flex-col md:flex-row gap-4 justify-center'>
                <Link to="/login" className='w-full md:w-auto'>
                    <Button variant="outline-info" className="w-full md:w-auto px-8 py-3 border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white rounded-lg">
                        Sign In
                    </Button>
                </Link>
