    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-black">
            ...
            <div className="text-center mb-8">
                <h1 className="text-5xl font-extrabold mb-4  text-[#FFD700]">MovieVerse</h1>
                <p className="text-lg md:text-xl font-light max-w-2xl mx-auto leading-relaxed text-[#FFD700]">
