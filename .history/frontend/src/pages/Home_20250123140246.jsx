...
const Home = () => {
    return (
        <div className="Home min-h-screen flex flex-col justify-center bg-gray-100">
            <div className="header text-center mb-10">
                <h1 className="logo text-4xl font-bold text-blue-500 mb-4">MovieVerse</h1>
                <p className="description text-lg text-gray-700 max-w-2xl mx-auto px-4">
                    Welcome to MovieVerse! Sign in or sign up to explore our movie universe.
                    Discover your next favorite film in an expansive universe of movie content. MovieVerse brings you the latest releases and timeless classics all in one place.
                </p>
            </div>
            <div className="buttons flex justify-center space-x-4">
                <Link to="/login" className="link">
                    <Button variant="outline-info" className="btn1 px-6 py-3 text-white bg-transparent border-2 border-blue-500 rounded-md hover:bg-blue-500 hover:text-white transition duration-300">
                        Sign In
                    </Button>
                </Link>
                <Link to="/register" className="link">
