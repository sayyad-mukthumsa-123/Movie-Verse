...
const SignIn = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-black">
      <div className="w-full max-w-md bg-black border border-white text-white rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4 relative">
            ...
            <button
              type="button"
              className="absolute top-14 right-3 text-2xl font-semibold  focus:outline-none"
          ...
          <div className="text-sm text-right mb-4">
            <button
              type="button"
              className="text-cyan-500 text-xl hover:underline focus:outline-none hover:scale-105 transition-transform"
              onClick={handleForgotPassword}
            >
              Forgot Password?
            </button>
          </div>
          <div className="text-xl mb-4 text-cyan-500">
            Don't have an account?{" "}
            <Link to="/register" className="inline-block mx-2 text-cyan-500 hover:underline hover:scale-105 transition-transform text-2xl">
              SignUp
            </Link>
          </div>
          <button
