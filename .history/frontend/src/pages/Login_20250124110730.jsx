    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4 relative">
            <label htmlFor="password" className="block  mb-2 font-medium text-cyan-800 text-2xl">
              Password
            </label>
            <input
              type={passwordVisible ? "text" : "password"}
            ...
            <button
              type="button"
              className="absolute top-14 right-3 text-2xl font-semibold text-cyan-800 focus:outline-none"
              onClick={togglePasswordVisibility}
            >
              {passwordVisible ? "Hide" : "Show"}
            </button>
          ...
          <div className="text-xl mb-4 text-cyan-800">
            Don't have an account?{" "}
            <Link to="/register" className="inline-block mx-2 text-blue-500 hover:underline hover:scale-105 transition-transform text-2xl">
              SignUp
            </Link>
          </div>
          <button
            type="submit"
            className="w-full scale-90 bg-green-800 text-2xl text-white py-2 px-4 rounded-lg hover:bg-green-700 focus:outline-none hover:scale-100 transition-transform"
          >
            Sign In
          </button>
        </form>
