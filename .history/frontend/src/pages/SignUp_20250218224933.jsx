      ...
      <div className="w-full max-w-lg bg-slate-50 rounded-lg shadow-md p-6">
        ...
        {step === 1 && !otpSent && (
          <>
            <button
              onClick={sendOtp}
              className=" hover:bg-cyan-700 scale-95 hover:scale-100 transition-all font-semibold hover:text-white text-cyan-700 outline text-xl py-2 px-4 rounded-lg w-full"
            >
              Send OTP
            </button>
