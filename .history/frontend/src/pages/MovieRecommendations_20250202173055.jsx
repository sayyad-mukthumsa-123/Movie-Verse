...
const MovieRecommendations = ({ movieId }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <h3 className="text-lg font-semibold text-center mb-4">Telugu Movies</h3>
      <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {recommendations.telugu?.map((movie) => (
          <li key={movie.id} className="bg-gray-800 p-4 rounded-lg shadow-lg hover:bg-gray-700 transition">
            <p className="text-white text-lg truncate">{movie.title}</p>
            <p className="text-gray-400 text-sm">{movie.overview.slice(0, 100)}...</p>
          </li>
      ...
      <h3 className="text-lg font-semibold text-center mb-4">Hindi Movies</h3>
      <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {recommendations.hindi?.map((movie) => (
          <li key={movie.id} className="bg-gray-800 p-4 rounded-lg shadow-lg hover:bg-gray-700 transition">
            <p className="text-white text-lg truncate">{movie.title}</p>
            <p className="text-gray-400 text-sm">{movie.overview.slice(0, 100)}...</p>
          </li>
      ...
      <h3 className="text-lg font-semibold text-center mb-4">English Movies</h3>
      <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {recommendations.english?.map((movie) => (
          <li key={movie.id} className="bg-gray-800 p-4 rounded-lg shadow-lg hover:bg-gray-700 transition">
            <p className="text-white text-lg truncate">{movie.title}</p>
            <p className="text-gray-400 text-sm">{movie.overview.slice(0, 100)}...</p>
          </li>
