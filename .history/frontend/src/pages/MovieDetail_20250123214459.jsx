        ...
        <div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start md:space-x-6 mb-8">
            ...
            <div className="w-full md:w-2/3 text-2xl">
              ...
              <p className="text-xl text-gray-700 mb-2">Released : {movie.release_date}</p>
              <p className="text-xl text-gray-700 mb-2">Genre : {movie.genres.map(genre => genre.name).join(', ')}</p>
              <p className="text-xl text-gray-700 mb-10">Director : {director}</p>
