  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-slate-900 text-slate-50 min-h-screen">
      ...
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto space-y-4">
        ...
        <button
          type="submit"
          className="w-full text-xl py-3 text-cyan-700 bg-slate-50 font-bold rounded-lg hover:bg-cyan-700 hover:text-slate-50 transition-all"
        >
          Submit
        </button>
      </form>
      ...
      <div className="mt-8">
        ...
        {reviews.length === 0 ? (
          <p className="text-center text-slate-50">No reviews yet.</p>
        ) : (
