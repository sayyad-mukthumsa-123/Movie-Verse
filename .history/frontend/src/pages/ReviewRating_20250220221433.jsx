  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-slate-900 text-slate-50 min-h-screen">
      ...
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto space-y-4 outline rounded-lg p-3">
        ...
        <Tippy content={<span className="text-red-600 text-2xl p-2 font-semibold">!!! Username is read-only</span>} theme="light" placement="right">
          <input
            type="text"
            value={username}
            readOnly
      ...
      {confirmDelete && (
        <div className="fixed inset-0 flex items-center justify-center bg-salte-900 bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Confirm Delete</h3>
            <p className="text-gray-600 text-xl mb-4">Enter "{username}" to confirm deletion</p>
            ...
            <div className="mt-6 flex justify-end space-x-4">
              <button
                ...
                className="px-4 py-2 text-xl bg-slate-50 text-slate-900 outline rounded-lg hover:bg-slate-900 hover:text-slate-50 transition-colors"
              >
                Cancel
              </button>
              <button
                onClick={handleDelete}
                className="px-4 py-2 text-xl bg-slate-50 text-red-500 outline rounded-lg hover:bg-red-500 hover:text-slate-50 transition-colors"
              >
                Delete
              </button>
            </div>
