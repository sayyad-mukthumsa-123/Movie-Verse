    ...
    <div className="container mx-auto px-4 py-6">
      {movie && (
        <div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start md:space-x-6 mb-8">
            ...
            <div className="w-full md:w-2/3">
              ...
              <div className="mb-4">
                ...
                <p className="text-2xl text-gray-800 text-justify">{movie.overview}</p>
              </div>
            </div>
          </div>
          ...
          {/* Trailer Section */}
          <div className="mb-8">
            <h2 className="text-3xl font-semibold text-cyan-800 mb-4">Trailer</h2>
            {trailerUrl ? (
          ...
          {cast.length > 0 && (
            <div>
              <h2 className="text-3xl font-semibold text-cyan-800 mb-4">Cast</h2>
                  ...
                  .map(actor => (
                    <div key={actor.id} className="text-center">
                      <img
                        src={`https://image.tmdb.org/t/p/w200${actor.profile_path}`}
                        alt={actor.name}
                        className="w-42 h-42 object-cover rounded-full mx-auto mb-2"
                      />
