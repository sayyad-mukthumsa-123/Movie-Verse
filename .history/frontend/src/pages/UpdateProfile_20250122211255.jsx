...
// //               required
// //               // className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm"
// //               className={`mt-1 block w-full px-3 py-2 border outline outline-cyan-800 rounded-md shadow-sm  focus:ring-2 focus:ring-cyan-500  focus:outline-red-500 sm:text-sm ${
// //                 error ? "border-cyan-500" : "border-gray-300"
// //               }`}
// //             />
// //           </div>
// //           <div>
...
// //               className="w-5/12 bg-green-800 text-xl hover:bg-green-800 hover:scale-110 transition-transform text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:bg-green-800"
// //             >
// //               Save
// //             </button>
// //             <button
// //               type="button"
// //               onClick={() => navigate(`/profile/${email}`)}
// //               className="w-5/12 text-2xl bg-red-500 hover:bg-red-500 hover:scale-110 transition-transform text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500"
// //             >
// //               Cancel
// //             </button>
// //           </div>
...
//               onChange={(e) => setUsername(e.target.value)}
//               required
//               className={` mt-1 block w-full px-3 py-2 text-lg border outline outline-cyan-800 rounded-md shadow-sm focus:ring-2 focus:ring-cyan-500 focus:outline-red-500 sm:text-sm`}
//             />
//           </div>
//           <div>
//             <AvatarSelection setSelectedAvatar={setSelectedAvatar} />
...
//               type="button"
//               onClick={handleSave}
//               className="w-5/12 bg-green-800 text-xl hover:bg-green-800 hover:scale-110 transition-transform text-white font-semibold py-2 px-4 rounded-md focus:outline-none  focus:bg-green-800"
//             >
//               Save
//             </button>
//             <button
//               type="button"
//               onClick={() => navigate(`/profile/${email}`)}
//               className="w-5/12 text-2xl bg-red-500 hover:bg-red-500 hover:scale-110 transition-transform text-white font-semibold py-2 px-4 rounded-md focus:outline-none  focus:ring-gray-500"
//             >
//               Cancel
//             </button>
//           </div>
        ...
        <form className="space-y-6">
          <div>
            ...
            <input
              ...
              onChange={(e) => setUsername(e.target.value)}
              required
              className="mt-1 block w-full px-3 py-2 text-base sm:text-lg border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-cyan-500 focus:outline-none"
            />
          </div>
          <div>
            <AvatarSelection setSelectedAvatar={setSelectedAvatar} />
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-4">
            <button
              type="button"
              onClick={handleSave}
              className="w-full sm:w-5/12 bg-green-700 text-lg sm:text-xl hover:bg-green-800 hover:scale-105 transition-transform text-white font-semibold py-2 px-4 rounded-md focus:outline-none"
            >
              Save
            </button>
            <button
              type="button"
              onClick={() => navigate(`/profile/${email}`)}
              className="w-full sm:w-5/12 bg-red-500 text-lg sm:text-xl hover:bg-red-600 hover:scale-105 transition-transform text-white font-semibold py-2 px-4 rounded-md focus:outline-none"
            >
              Cancel
            </button>
          </div>
