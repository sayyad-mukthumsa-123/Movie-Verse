    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[ #F7F7F7]">
            ...
            <div className="text-center mb-8">
                <h1 className="text-5xl font-extrabold mb-4  text-[#D15D79]">MovieVerse</h1>
                <p className="text-lg md:text-xl font-light max-w-2xl mx-auto leading-relaxed text-[#D15D79]">
