...
const MovieDetail = () => {
  ...
  return (
    <div className="container  bg-slate-900 text-slate-50 mx-auto px-4 py-6">
      <div className="absolute top-3 left-2 cursor-pointer outline p-2 bg-slate-900 text-slate-50 rounded-full hover:bg-slate-50 hover:text-slate-900 hover:scale-105 transition-all">
