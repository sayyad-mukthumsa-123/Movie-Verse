      ...
      <div className="bg-white shadow-md rounded-lg p-6 w-96">
        ...
        <div className="flex flex-col space-y-4">
          <button
            ...
            className="bg-green-800 text-xl text-white py-2 px-4 rounded-lg hover:bg-green-800  hover:scale-110 transition-transform duration-300 transition"
          >
            Update Profile
          </button>
          <button
            onClick={handleResetPasswordClick}
            className="bg-blue-500 text-xl text-white py-2 px-4 rounded-lg hover:bg-red-600 transition"
          >
            Reset Password
          </button>
        </div>
