          ...
          <>
            ...
            <div className="mb-4">
              ...
              <div className="mt-4 text-center">
                <button
                  onClick={sendOtp}
                  className={`text-xl font-medium ${resendDisabled ? "text-gray-400 cursor-not-allowed" : "hover:bg-cyan-700 text-cyan-700 outline hover:text-white text-xl py-2 px-4 rounded-lg w-full mt-5"}`}
