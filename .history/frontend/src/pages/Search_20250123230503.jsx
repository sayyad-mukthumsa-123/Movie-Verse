...
const Search = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
      <h1 className="text-4xl font-semibold text-center text-gray-800 mb-8">Search Options</h1>
      <div className="flex flex-wrap justify-center gap-4 w-full max-w-4xl px-4">
        <Link
          to="/search/movie"
          className="bg-blue-500 text-white py-2 px-6 rounded-lg shadow-md hover:bg-blue-600 transition duration-300 w-full sm:w-auto"
          onClick={clearSearchData}
        >
          Search by Movie
        </Link>
        <Link
          to="/search/director"
          className="bg-green-500 text-white py-2 px-6 rounded-lg shadow-md hover:bg-green-600 transition duration-300 w-full sm:w-auto"
          onClick={clearSearchData}
        >
          Search by Director
        </Link>
        <Link
          to="/search/hero"
          className="bg-red-500 text-white py-2 px-6 rounded-lg shadow-md hover:bg-red-600 transition duration-300 w-full sm:w-auto"
          onClick={clearSearchData}
        >
          Search by Hero
        </Link>
        <Link
          to="/search/heroine"
          className="bg-purple-500 text-white py-2 px-6 rounded-lg shadow-md hover:bg-purple-600 transition duration-300 w-full sm:w-auto"
          onClick={clearSearchData}
        >
          Search by Heroine
        </Link>
        <Link
          to="/search/genre"
          className="bg-yellow-500 text-white py-2 px-6 rounded-lg shadow-md hover:bg-yellow-600 transition duration-300 w-full sm:w-auto"
          onClick={clearSearchData}
        >
          Search by Genre
        </Link>
        <Link
          to="/search/lang"
          className="bg-indigo-500 text-white py-2 px-6 rounded-lg shadow-md hover:bg-indigo-600 transition duration-300 w-full sm:w-auto"
          onClick={clearSearchData}
        >
          Search by Language
        </Link>
