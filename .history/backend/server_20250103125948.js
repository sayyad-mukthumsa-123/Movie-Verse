...
const middleware = require("./middleware/middleware");
const path = require('path');
const axios = require('axios');  // Import axios here as well
...
// Import the recommendationController
const recommendationController = require("./controllers/recommendationController");

// Recommendation route
app.get("/api/recommendations", middleware, recommendationController.getRecommendations);
