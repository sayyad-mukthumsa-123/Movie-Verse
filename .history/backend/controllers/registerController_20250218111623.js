...
// //     let avatarSvg;
// //     if (Avatar) {
// //       avatarSvg = Avatar; // Avatar can be base64 string or SVG
// //     } else {
// //       avatarSvg = multiavatar(Username); // Generate from username
// //     }
...
const Register = async (req, res) => {
  try {
    ...
    const newUser = new UserModel({
      ...
      Email,
      Password: hashedPassword,
      Avatar, // Store the selected avatar directly from request
    });
