...
const Register = async (req, res) => {
    try {
        ...
        // Fetch avatar from multiavatar API
        const avatarUrl = `https://api.multiavatar.com/${Math.floor(Math.random() * 100000000)}.svg`;
        ...
        return res.status(500).json({ msg: `Internal server error: ${error.message}` });  // Return more detailed error
    }
};
