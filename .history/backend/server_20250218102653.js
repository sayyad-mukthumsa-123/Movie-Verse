...
let otpStore = {}; // Temporary in-memory store for OTPs (can be replaced with a database)
...
app.post("/send-otp", async (req, res) => {
  ...
  otpStore[email] = otp; // Store OTP temporarily in memory (use a DB in production)
