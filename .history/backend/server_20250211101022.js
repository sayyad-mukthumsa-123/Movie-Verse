...
// Route to fetch avatars (Fixing CORS issue)
// app.get("/api/avatars", async (req, res) => {
//   try {
//     const avatars = [];
//     for (let i = 0; i < 4; i++) {
//       const randomId = Math.round(Math.random() * 1000);
//       const response = await axios.get(`https://api.multiavatar.com/${randomId}`, { responseType: "text" });
//       avatars.push(`data:image/svg+xml;base64,${Buffer.from(response.data).toString("base64")}`);
//     }
//     res.json(avatars);
//   } catch (error) {
